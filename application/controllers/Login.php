...
class Login extends CI_Controller {
	...
	function sendemail(){
        ...
        //     'smtp_user' => 'system@kwikkiangie.ac.id',  // Email gmail
        //     'smtp_pass'   => 'fingerprint2016',  // Password gmail
        //     'smtp_crypto' => 'ssl',
        //     'smtp_port'   => 465,
        //     'crlf'    => "\r\n",
        //     'newline' => "\r\n"
        ...
        // $this->email->from('system@kwikkiangie.ac.id', 'MasRud.com');

        // // Email penerima
        // $this->email->to('iqbalhanafi436@gmail.com'); // Ganti dengan email tujuan
		...
		// $mail->Username   = "system@kwikkiangie.ac.id";
		// $mail->Password   = "fingerprint2016";
			
		// $mail->IsHTML(true);
		// $mail->AddAddress("iqbal.hanafi@kwikkiangie.ac.id", "Hanafi");
		// $mail->SetFrom("iqbalhanafi436@gmail.com", "iqbal");
		// $mail->AddReplyTo("warnabiru07@gmail.com", "admin");

...
<?php 
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://usm.kwikkiangie.ac.id">
         
        <div class="sidebar-brand-text mx-3" ><img src="<?=base_url()?>images/LOGO-IBI-PUTIH-1024x474.png" class="img img-responsive" style="width:auto;height:3.5rem"></div>

...
$namalengkap = $result['first_name'].' '.$result['last_name'];
  ...
  <tbody>
    <tr>
      <td style="line-height: 0.4">
        <p style="font-size: 14px; font-weight:bold; font-color:#777777">Event</p>
        <p style="font-size: 22px; font-weight:bold;"><?=$acara?></p>
      </td>
    </tr>
    <tr>
      <td style="line-height: 0.4">
        <p style="font-size: 14px; font-weight:bold; font-color:#777777">Nama</p>
        <p style="font-size: 22px; font-weight:bold;"><?=$namalengkap?></p>
      </td>
    </tr>
    <tr>
      <td style="line-height: 0.4">
    ...
    <tr>
      <td style="line-height: 0.4">
        <p style="font-size: 14px; font-weight:bold; font-color:#777777">Email</p>
        <p style="font-size: 22px; font-weight:bold;"><?=$result['email']?></p>
      </td>
    </tr>
    <tr>
      <td style="line-height: 0.4">
        <p style="font-size: 14px; font-weight:bold; font-color:#777777">Total Benar</p>
        <p style="font-size: 22px; font-weight:bold;"><?=$jumlahbenar?></p>
      </td>
    </tr>
    <tr>
      <td style="line-height: 0.4">
        <p style="font-size: 14px; font-weight:bold; font-color:#777777">Status</p>
        <p style="font-size: 22px; font-weight:bold;"><?=$status?></p>
      </td>
    </tr>
    <tr>
      <td style="line-height: 0.4">
        <p style="font-size: 14px; font-weight:bold; font-color:#777777">Persentase</p>
    ...
    ?>
      <td colspan="2">
      <p style="font-size: 16px">Jika ingin melanjutkan ke tahap selanjutnya mohon klik tombol dibawah ini</p><a class="btn btn-success" href="<?=$url?>" target="_blank">Lanjutkan</a>
      </td>
      <td></td>
    </tr> -->
	<tr>
		<td colspan="2">
		<p>Informasi lebih lanjut bisa hubungi Admisi IBIKKG <a target="_blank" class="btn btn-warning" style="padding: 1px; 2px;" href="https://kwikkiangie.ac.id/home/admisi/panduan-penerimaan-mahasiswa-baru/">Di Sini</a></p>
		</td>
	</tr>
  </tbody>
</table>

...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'system@kwikkiangie.ac.id'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Rizaldi Maulidia Achmad'; // Isikan dengan nama pengirim
    protected $password = 'fingerprint2016'; // Isikan dengan password email pengirim
